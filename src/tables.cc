...
std::string getRTPlusContentTypeName(uint16_t content_type) {
  static const std::vector<std::string> content_type_names({
      ...
      "stationname.short","stationname.long","programme.now","programme.next",
      "programme.part","programme.host","programme.editorial_staff",
      "programme.frequency","programme.homepage","programme.subchannel",
      "phone.hotline","phone.studio","phone.other","sms.studio","sms.other",
      "email.hotline","email.studio","email.other","mms.other","chat",
      "chat.centre","vote.question","vote.centre","unknown","unknown","unknown",
      "unknown","unknown","place","appointment","identifier","purchase",
      "get_data"
  });
