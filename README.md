...
Redsea can be run on Raspberry Pi 1 by changing `-A std` to `-A fast` in `rtl-rx.sh`. This changes the arctan calculation in the FM demodulator to a fast integer approximation.
